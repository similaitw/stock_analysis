# Auto-generated strategies for: 函數/價格計算
import pandas as pd
import numpy as np

class 價格計算Strategies:

    @staticmethod
    def Average(df: pd.DataFrame, thePrice: str = "numericseries", Length: str = "numericsimple") -> tuple[bool, str]:
        """
        Original Strategy: Average
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\Average.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
        if  Length > 0 then
    ...
    @staticmethod
    def AvgDeviation(df: pd.DataFrame, thePrice: str = "numericseries", Length: str = "numericsimple") -> tuple[bool, str]:
        """
        Original Strategy: AvgDeviation
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\AvgDeviation.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
        			averageprice(0),
    ...
    @staticmethod
    def DwLimit(df: pd.DataFrame, refPrice: str = "numericsimple") -> tuple[bool, str]:
        """
        Original Strategy: DwLimit
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\DwLimit.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
    ...
    @staticmethod
    def EMA(df: pd.DataFrame, thePrice: str = "numericseries", Length: str = "Numeric") -> tuple[bool, str]:
        """
        Original Strategy: EMA
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\EMA.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(2);
    ...
    @staticmethod
    def Range(df: pd.DataFrame) -> tuple[bool, str]:
        """
        Original Strategy: Range
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\Range.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
        Range = High - Low;
    ...
    @staticmethod
    def RateOfChange(df: pd.DataFrame, thePrice: str = "numericseries", Length: str = "numericsimple") -> tuple[bool, str]:
        """
        Original Strategy: RateOfChange
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\RateOfChange.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
    ...
    @staticmethod
    def ReadTicks(df: pd.DataFrame, readtick_cookie: str = "NumericRef") -> tuple[bool, str]:
        """
        Original Strategy: ReadTicks
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\ReadTicks.xs
        XS Logic Reference:
        {@type:function}
        {
    ...
    @staticmethod
    def Summation(df: pd.DataFrame, thePrice: str = "numericseries", Length: str = "numericsimple") -> tuple[bool, str]:
        """
        Original Strategy: Summation
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\Summation.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
        Sum=0;
    ...
    @staticmethod
    def TrueRange(df: pd.DataFrame) -> tuple[bool, str]:
        """
        Original Strategy: TrueRange
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\TrueRange.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
    ...
    @staticmethod
    def UpLimit(df: pd.DataFrame, refPrice: str = "numericsimple") -> tuple[bool, str]:
        """
        Original Strategy: UpLimit
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\UpLimit.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
        if date < 20150601 then begin
    ...
    @staticmethod
    def WMA(df: pd.DataFrame, thePrice: str = "numericseries", Length: str = "Numeric") -> tuple[bool, str]:
        """
        Original Strategy: WMA
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\WMA.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(1);
    ...
    @staticmethod
    def XAverage(df: pd.DataFrame, thePrice: str = "numericseries", Length: str = "Numeric") -> tuple[bool, str]:
        """
        Original Strategy: XAverage
        Source: e:\anti-gravity\stock\stock_analysis\temp_xscript_preset\函數\價格計算\XAverage.xs
        XS Logic Reference:
        {@type:function}
        SetBarMode(2);
        if length + 1 = 0 then Factor = 1 else Factor = 2 / (Length + 1);
